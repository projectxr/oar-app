...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> llm_cpp::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => llm_cpp::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => llm_cpp::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => llm_cpp::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => llm_cpp::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> llm_cpp::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                llm_cpp::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                llm_cpp::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                llm_cpp::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                llm_cpp::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&llm_cpp::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        llm_cpp::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &llm_cpp::llama_model_kv_override,
